...
const PAGE_CSS = `
  ...
  * { box-sizing: border-box; }
  ...
  .hero-title { display:flex; align-items:center; gap:18px; min-height:106px; padding:16px 28px; border-radius:28px; background:linear-gradient(110deg,#5b75ff 0%,#5963f6 52%,#8a4eea 100%); color:#fff; box-shadow:0 18px 44px rgba(84,91,235,.22); margin-bottom:24px; overflow:hidden; position:relative; }
  ...
  .hero-icon { width:72px; height:72px; border-radius:50%; background:linear-gradient(145deg,rgba(255,255,255,.20),rgba(42,57,210,.34)); border:1px solid rgba(255,255,255,.25); display:flex; align-items:center; justify-content:center; flex:0 0 auto; box-shadow:inset 0 0 0 7px rgba(255,255,255,.07),0 10px 22px rgba(27,38,150,.18); position:relative; z-index:1; }
  .person-icon { width:42px; height:42px; display:block; }
  .avatar { width:58px; height:58px; border-radius:50%; background:linear-gradient(145deg,#5c73ff,#6d43e8); display:flex; align-items:center; justify-content:center; flex:0 0 auto; box-shadow:0 9px 20px rgba(79,99,255,.20); border:1px solid rgba(255,255,255,.35); }
  .avatar svg { width:32px; height:32px; display:block; }
  .identity .avatar { width:58px; height:58px; }
  .hero-title h1 { margin:0; font-size:34px; line-height:1; letter-spacing:-1px; font-weight:750; position:relative; z-index:1; }
  .hero-title p { margin:6px 0 0; color:rgba(255,255,255,.82); font-size:14px; position:relative; z-index:1; }

  .profile-shell { display:grid; grid-template-columns:minmax(0,1.6fr) minmax(300px,.8fr); gap:20px; align-items:start; }
  .card-wrap { background:rgba(255,255,255,.96); border:1px solid var(--line); border-radius:17px; padding:17px; margin-bottom:17px; box-shadow:0 12px 34px rgba(65,76,160,.08); transition:transform .25s ease,box-shadow .25s ease,border-color .25s ease; }
  .card-wrap:hover { transform:translateY(-2px); box-shadow:0 18px 40px rgba(65,76,160,.11); border-color:#d9def7; }
  .identity { display:flex; align-items:center; gap:13px; padding-bottom:14px; border-bottom:1px solid var(--line); }
  .avatar { width:58px; height:58px; border-radius:50%; background:linear-gradient(145deg,#5c73ff,#6d43e8); display:flex; align-items:center; justify-content:center; flex:0 0 auto; box-shadow:0 9px 20px rgba(79,99,255,.20); border:1px solid rgba(255,255,255,.35); }
  ...
  .section-title { display:flex; align-items:center; gap:10px; margin:0 0 13px; font-size:13px; font-weight:750; color:#1c2a64; }
  .section-icon { width:27px; height:27px; border-radius:8px; background:#eeedff; color:#5a4cf2; display:flex; align-items:center; justify-content:center; font-weight:800; font-size:16px; }
  .stat-grid { display:grid; grid-template-columns:repeat(3,1fr); gap:13px; }
  .stat-box { background:linear-gradient(180deg,#fbfbff,#f7f7ff); border:1px solid var(--line); border-radius:11px; padding:13px 10px; text-align:center; transition:transform .22s ease,box-shadow .22s ease; }
  .stat-box:hover { transform:translateY(-3px); box-shadow:0 10px 22px rgba(79,99,255,.09); }
  .stat-box .num { font-size:19px; font-weight:800; color:#1d2b68; }
        ...
        <div className="wrap">
          <section className="hero-title">
            <div className="hero-icon">
              <svg className="person-icon" viewBox="0 0 48 48" aria-hidden="true">
                <circle cx="24" cy="15" r="8.5" fill="none" stroke="white" strokeWidth="3.5"/>
                <path d="M9 39c0-8.2 6.6-13.2 15-13.2S39 30.8 39 39" fill="none" stroke="white" strokeWidth="3.5" strokeLinecap="round"/>
                <path d="M15 35.5h18" fill="none" stroke="white" strokeWidth="3.5" strokeLinecap="round"/>
              </svg>
            </div>
            <div>
              <h1>Profile</h1>
                ...
                <div className="identity">
                  <div className="avatar" aria-label="Profile">
                    <svg viewBox="0 0 48 48" aria-hidden="true">
                      <circle cx="24" cy="15" r="8" fill="none" stroke="white" strokeWidth="3.5"/>
                      <path d="M9 39c0-8.2 6.6-13.2 15-13.2S39 30.8 39 39" fill="none" stroke="white" strokeWidth="3.5" strokeLinecap="round"/>
                      <path d="M15 35.5h18" fill="none" stroke="white" strokeWidth="3.5" strokeLinecap="round"/>
                    </svg>
                  </div>
